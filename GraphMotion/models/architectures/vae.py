...
from GraphMotion.models.architectures.tools.embeddings import TimestepEmbedding, Timesteps
from GraphMotion.models.operator import PositionalEncoding
from GraphMotion.models.operator.cross_attention import (
...
class Vae(nn.Module):
    ...
    def __init__(self,
        ...
        output_feats = 263
        if self.nfeats != 263:
            self.input_proj = nn.Linear(nfeats, 263)
            self.output_proj = nn.Linear(263, nfeats)
