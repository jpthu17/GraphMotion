...
from GraphMotion.data.humanml.scripts.motion_process import (qrot,
    ...
    def update(self, rs_set):
        ...
        if self.stage in ["diffusion", "vae_diffusion"]:
            ...
            if self.predict_epsilon:
                ...
                total += self._update_loss("inst_loss", rs_set['noise_pred_1'],
                                           rs_set['noise_1'])

                total += self._update_loss("inst_loss", rs_set['noise_pred_2'],
                                           rs_set['noise_2'])

                total += self._update_loss("inst_loss", rs_set['noise_pred_3'],
                                           rs_set['noise_3'])
