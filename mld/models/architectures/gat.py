...
class GATLayer(nn.Module):
    ...
    def forward(self, h0, h1, multi_adj, adj):
        ...
        # print("Wh", Wh0.size(), Wh1.size()) Wh torch.Size([32, 16, 768]) torch.Size([32, 16, 768])

        a_input = self._prepare_attentional_mechanism_input(Wh0, Wh1)
        # print("a_input", a_input.size()) a_input torch.Size([32, 16, 16, 1536])
        ...
        # print("e", e.size()) e torch.Size([32, 16, 16])
        ...
        # print("h_prime", h_prime.size()) h_prime torch.Size([32, 16, 768])
    ...
    def _prepare_attentional_mechanism_input(self, Wh0, Wh1):
        ...
        # print("Wh0, Wh1", Wh0_repeated_in_chunks.size(), Wh1_repeated_alternating.size()) Wh0, Wh1 torch.Size([32, 256, 768]) torch.Size([32, 256, 768])
