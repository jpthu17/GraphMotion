...
from GraphMotion.callback import ProgressLogger
from GraphMotion.config import parse_args
from GraphMotion.data.get_data import get_datasets
from GraphMotion.models.get_model import get_model
from GraphMotion.utils.logger import create_logger
...
def main():
    ...
    metric_monitor = {
        ...
        "1_R_TOP_1": "Metrics/s1_R_precision_top_1",
        "1_R_TOP_2": "Metrics/s1_R_precision_top_2",
        "1_R_TOP_3": "Metrics/s1_R_precision_top_3",

        "2_R_TOP_1": "Metrics/s2_R_precision_top_1",
        "2_R_TOP_2": "Metrics/s2_R_precision_top_2",
        "2_R_TOP_3": "Metrics/s2_R_precision_top_3",

        "3_R_TOP_1": "Metrics/s3_R_precision_top_1",
        "3_R_TOP_2": "Metrics/s3_R_precision_top_2",
        "3_R_TOP_3": "Metrics/s3_R_precision_top_3",
        ...
        "1_Diversity": "Metrics/1_Diversity",
        "2_Diversity": "Metrics/2_Diversity",
        "3_Diversity": "Metrics/3_Diversity",

        "gt_Diversity": "Metrics/gt_Diversity",
        "MM dist": "Metrics/Matching_score",

        "1_MM dist": "Metrics/s1_Matching_score",
        "2_MM dist": "Metrics/s2_Matching_score",
        "3_MM dist": "Metrics/s3_Matching_score",

        "MultiModality": "Metrics/MultiModality",

        "1_MultiModality": "Metrics/s1_MultiModality",
        "2_MultiModality": "Metrics/s2_MultiModality",
        "3_MultiModality": "Metrics/s3_MultiModality",
